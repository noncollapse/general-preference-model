...
def train(args):
    ...
    dataset = dataset.remove_columns(["a_1","a_2"])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str, default="../results/gpm_tldr/checkpoint")
    ...
    parser.add_argument("--is_custom_dataset", action="store_true", default=True, help="Whether to use custom cyclic dataset. Default to False.")
    parser.add_argument("--is_general_preference", action="store_true", default=True, help="Whether to use General Preference model. Default to False (Bradley Terry model by default).")
    ...
    parser.add_argument("--wandb_group", type=str, default="Tripleleg")
